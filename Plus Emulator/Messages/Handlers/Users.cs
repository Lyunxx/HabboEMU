...
namespace Plus.Messages.Handlers
{
    ...
    partial class GameClientMessageHandler
    {
        ...
        internal void ChangeLook()
        {
            ...
            {
                Session.SendWhisper("Você não pode mudar sua aparência enquanto trabalha!");
                return;
            }
            if (Session.GetHabbo().CurrentRoom.RoomData.Description.Contains("CLOTHING_STORE"))
            {
                ...
                {
                    Session.SendWhisper("Você não tem $2 para mudar sua aparência!");
                    return;
                }
            ...
            else if (Session.GetHabbo().CurrentRoom.RoomData.Description.Contains("HAIR_STORE"))
            {
                if (Session.GetHabbo().Credits < 2)
                {
                    Session.SendWhisper("Você não tem $2 para mudar seu cabelo!");
                    return;
                }
            ...
            {
                Session.SendWhisper("Você não pode trocar de roupa [Room ID: 3] ou seu cabelo [Room ID: 11] aqui");
            }
        }
        ...
        internal void ChangeMotto()
        {
            ...
            {
                Session.SendWhisper("Você não pode mudar sua missão");
                return;
            }
        ...
        internal void SaveWardrobe()
        {
            if (Session.GetRoleplay().Working)
            {
                Session.SendModeratorMessage("Você não pode roubar sua roupa de trabalho, vagabund@");
            }
            else
            {
                var num = Request.GetUInteger();
