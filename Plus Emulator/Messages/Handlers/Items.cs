    ...
    partial class GameClientMessageHandler
    {
        ...
        internal void PickUpPet()
        {
            ...
            if(pet.BotData != null)
            {
                ...
                {
                    Session.SendWhisper("Este não é seu animal de estimação, pare de tentar pegá-lo?! Se você é um funcionário, basta usar o comando: killpet!");
                    return;
                }
            }
        ...
        internal void ConfirmLoveLock()
        {
            ...
            if (userOne == null)
            {
                ...
                userTwo.GetClient().SendNotif("Seu parceiro saiu da sala ou cancelou o bloqueio de amor.");
            ...
            if (userTwo == null)
            {
                ...
                userOne.GetClient().SendNotif("Seu parceiro saiu da sala ou cancelou o bloqueio de amor.");
