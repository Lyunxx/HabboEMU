...
namespace Plus.Messages.Handlers
{
    ...
    internal partial class GameClientMessageHandler
    {
        ...
        internal void AcceptRequest()
        {
            ...
            {
                Session.SendNotif("Você não tem um telefone para aceitar contatos!");
                return;
            }
        ...
        internal void RequestBuddy()
        {
            if (Session.GetRoleplay().Phone == 0)
            {
                Session.SendNotif("Você não tem um telefone para solicitar solicitações de contato!");
                return;
            }
        ...
        {
            if (Session.GetHabbo().Rank < 9) { Session.SendNotif("Você não tem permissão para seguir o seu amigo!");  return; }
